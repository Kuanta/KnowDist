...
python test.py --exp_id=27 --exp_no=1 --n_rules=7 --fuzzy_type=1 --dataset=2 --n_inputs=30 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=28 --exp_no=1 --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=30 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=29 --exp_no=1 --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=30 --use_sigma_scale=1 --use_height_scale=1
python test.py --exp_id=30 --exp_no=1 --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=30 --use_sigma_scale=1 --use_height_scale=0
python test.py --exp_id=31 --exp_no=1  --n_rules=7 --fuzzy_type=1 --dataset=2 --n_inputs=30 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=32 --exp_no=1  --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=30 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=33 --exp_no=1  --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=30 --use_sigma_scale=1 --use_height_scale=1
python test.py --exp_id=34 --exp_no=1  --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=30 --use_sigma_scale=1 --use_height_scale=0

python test.py --exp_id=35 --exp_no=1 --n_rules=7 --fuzzy_type=1 --dataset=2 --n_inputs=5 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=36 --exp_no=1 --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=5 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=37 --exp_no=1 --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=5 --use_sigma_scale=1 --use_height_scale=1
python test.py --exp_id=38 --exp_no=1 --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=5 --use_sigma_scale=1 --use_height_scale=0
python test.py --exp_id=39 --exp_no=1  --n_rules=7 --fuzzy_type=1 --dataset=2 --n_inputs=5 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=40 --exp_no=1  --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=5 --use_sigma_scale=0 --use_height_scale=1
python test.py --exp_id=41 --exp_no=1  --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=5 --use_sigma_scale=1 --use_height_scale=1
python test.py --exp_id=42 --exp_no=1  --n_rules=7 --fuzzy_type=2 --dataset=2 --n_inputs=5 --use_sigma_scale=1 --use_height_scale=0