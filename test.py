...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_no", type=int)
    parser.add_argument("--fuzzy_type", default=2, type=int)
    parser.add_argument("--use_sigma_scale", type=int)
    parser.add_argument("--use_height_scale", type=int)
    parser.add_argument("n_inputs", type=int)
    parser.add_argument("--n_rules", type=int)
    parser.add_argument("--dataset")

    args = parser.parse_args()

    if args.dataset == 2:  # Cifar
